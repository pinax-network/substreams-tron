...
ALTER TABLE sunpump_launcher_changed
    ...
    -- indexes --
    ADD INDEX IF NOT EXISTS idx_old_launcher (old_launcher) TYPE bloom_filter(0.005) GRANULARITY 1,
    ADD INDEX IF NOT EXISTS idx_new_launcher (new_launcher) TYPE bloom_filter(0.005) GRANULARITY 1;
...
ALTER TABLE sunpump_operator_changed
    ...
    -- indexes --
    ADD INDEX IF NOT EXISTS idx_old_operator (old_operator) TYPE bloom_filter(0.005) GRANULARITY 1,
    ADD INDEX IF NOT EXISTS idx_new_operator (new_operator) TYPE bloom_filter(0.005) GRANULARITY 1;
...
ALTER TABLE sunpump_owner_changed
    ...
    -- indexes --
    ADD INDEX IF NOT EXISTS idx_old_owner (old_owner) TYPE bloom_filter(0.005) GRANULARITY 1,
    ADD INDEX IF NOT EXISTS idx_new_owner (new_owner) TYPE bloom_filter(0.005) GRANULARITY 1;
...
ALTER TABLE sunpump_pending_owner_set
    ...
    -- indexes --
    ADD INDEX IF NOT EXISTS idx_old_pending_owner (old_pending_owner) TYPE bloom_filter(0.005) GRANULARITY 1,
    ADD INDEX IF NOT EXISTS idx_new_pending_owner (new_pending_owner) TYPE bloom_filter(0.005) GRANULARITY 1;
...
ALTER TABLE sunpump_token_create
    ...
    -- indexes --
    ADD INDEX IF NOT EXISTS idx_token_address (token_address) TYPE bloom_filter(0.005) GRANULARITY 1,
    ADD INDEX IF NOT EXISTS idx_token_index (token_index) TYPE minmax GRANULARITY 1,
    ADD INDEX IF NOT EXISTS idx_creator (creator) TYPE bloom_filter(0.005) GRANULARITY 1;
