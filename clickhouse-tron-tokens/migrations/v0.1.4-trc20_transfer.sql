...
CREATE TABLE IF NOT EXISTS trc20_transfer_minutes ON CLUSTER 'tokenapis-a'  (
    -- order keys --
...
CREATE MATERIALIZED VIEW IF NOT EXISTS mv_trc20_transfer_minutes ON CLUSTER 'tokenapis-a'
